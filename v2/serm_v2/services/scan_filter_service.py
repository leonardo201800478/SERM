...
class ScanFilterService:
    ...
    def apply_mame(cls, scan_path: Path, profile, fundamental_values: dict[str, bool], category_values: dict[str, list[str]] | None = None) -> dict:
        ...
        category_names = MameCategoryFilterService.matching_machine_names(category_values, database_path())
        kept: list[dict] = []
        reasons = Counter()
        ...
        result = {
            ...
            "filters": {
                ...
                "catlist": {"categories": sorted(category_values.get("categories", [])), "subcategories": sorted(category_values.get("subcategories", []))},
