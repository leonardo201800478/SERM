...
class MainWindow(QMainWindow):
    ...
    def _on_scan_requested(self, profile: FilterProfileData) -> None:
        self.reconstruction_tab.set_scan_context(profile)
        self.status_bar.showMessage(f"Scan preparado: {profile.name} | profile_id={profile.profile_id}")

    def _on_reconstruction_requested(self, profile: FilterProfileData) -> None:
        self.reconstruction_tab.set_scan_context(profile)
