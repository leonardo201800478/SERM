...
class EmulatorSettingsPage(QWidget):
    ...
    SPECS: dict[str, tuple[SettingSpec, ...]] = {
        "mame": (
            SettingSpec("video", "Driver de vídeo", "combo", "Vídeo", (("bgfx", "BGFX"), ("d3d", "Direct3D 9"), ("opengl", "OpenGL"), ("gdi", "GDI"), ("soft", "Software"), ("none", "Sem vídeo")), description="MAME 0.289 documenta estes backends; em Windows, d3d é o padrão."),
            SettingSpec("bgfx_backend", "Backend BGFX", "combo", "Vídeo", (("auto", "Automático"), ("d3d9", "Direct3D 9"), ("d3d11", "Direct3D 11"), ("d3d12", "Direct3D 12"), ("opengl", "OpenGL"), ("vulkan", "Vulkan")), description="Backend usado quando o vídeo está em BGFX."),
            SettingSpec("filter", "Filtragem bilinear", "bool", "Vídeo", description="Ligado aplica filtragem; desligado usa point filtering."),
            SettingSpec("prescale", "Prescale", "slider", "Vídeo", minimum=1, maximum=5, description="Pré-ampliação por nearest-neighbor antes da escala final."),
            ...
            SettingSpec("priority", "Prioridade do processo", "slider", "Desempenho", minimum=0, maximum=7),
            ...
            SettingSpec("gl_glsl_filter", "Filtro GLSL", "combo", "Avançado", (("0", "Plain"), ("1", "Bilinear"), ("2", "Bicubic"))),
        ),
        "fbneo": (
            ...
            SettingSpec("nAudSegCount", "Buffer de áudio", "slider", "Áudio", minimum=2, maximum=20),
            SettingSpec("nAudSampleRate[0]", "Sample rate DirectSound", "combo", "Áudio", (("22050", "22.05 kHz"), ("44100", "44.1 kHz"), ("48000", "48 kHz"), ("96000", "96 kHz"))),
            SettingSpec("nAudSampleRate[1]", "Sample rate XAudio2", "combo", "Áudio", (("22050", "22.05 kHz"), ("44100", "44.1 kHz"), ("48000", "48 kHz"), ("96000", "96 kHz"))),
            SettingSpec("nInterpolation", "Interpolação PCM", "slider", "Áudio", minimum=0, maximum=3),
            SettingSpec("nFMInterpolation", "Interpolação FM", "slider", "Áudio", minimum=0, maximum=3),
            SettingSpec("bAutoPause", "Pausar ao perder foco", "bool", "Controles"),
            SettingSpec("bAlwaysProcessKeyboardInput", "Processar teclado sem foco", "bool", "Controles"),
            ...
            SettingSpec("nIpsSelectedLanguage", "Idioma do IPS", "slider", "Sistema", minimum=0, maximum=20),
            SettingSpec("nEnableHighResTimer", "High resolution timer", "bool", "Desempenho"),
            SettingSpec("bRewindEnabled", "Rewind", "bool", "Desempenho"),
            SettingSpec("nRewindMemory", "Memória do rewind (MB)", "slider", "Desempenho", minimum=64, maximum=4096),
        ),
        "flycast": (
            SettingSpec("Dreamcast.Cable", "Saída de vídeo", "combo", "Vídeo", (("0", "VGA"), ("1", "RGB"), ("2", "VGA Box"), ("3", "TV Composite"))),
            SettingSpec("Dreamcast.Region", "Região", "combo", "Sistema", (("0", "Japão"), ("1", "USA"), ("2", "Europa"), ("3", "Automática"))),
            SettingSpec("Dreamcast.Broadcast", "Broadcast", "slider", "Vídeo", minimum=0, maximum=4),
            SettingSpec("Dreamcast.Language", "Idioma", "combo", "Sistema", (("0", "Japonês"), ("1", "Inglês"), ("2", "Alemão"), ("3", "Francês"), ("4", "Espanhol"), ("5", "Italiano"), ("6", "Automático"))),
            ...
            SettingSpec("aica.BufferSize", "Buffer de áudio", "slider", "Áudio", minimum=512, maximum=8192),
            SettingSpec("audio.backend", "Backend de áudio", "combo", "Áudio", (("auto", "Automático"), ("wasapi", "WASAPI"), ("sdl2", "SDL2"), ("null", "Nulo"))),
            ...
            SettingSpec("rend.TextureUpscale", "Upscale de texturas", "slider", "Vídeo", minimum=1, maximum=8),
            SettingSpec("rend.MaxFilteredTextureSize", "Tamanho máximo filtrado", "slider", "Vídeo", minimum=64, maximum=4096),
            SettingSpec("rend.ScreenScaling", "Escala da tela", "slider", "Vídeo", minimum=1, maximum=800),
            SettingSpec("rend.ScreenStretching", "Alongamento", "slider", "Vídeo", minimum=1, maximum=200),
            ...
            SettingSpec("pvr.MaxThreads", "Threads do PVR", "slider", "Desempenho", minimum=1, maximum=16),
            SettingSpec("input.MouseSensitivity", "Sensibilidade do mouse", "slider", "Controles", minimum=1, maximum=200),
        ...
        "supermodel": (
            ...
            SettingSpec("MusicVolume", "Volume de música", "slider", "Áudio", minimum=0, maximum=200),
            SettingSpec("Balance", "Balanço", "slider", "Áudio", minimum=-100, maximum=100),
            SettingSpec("InputSystem", "Sistema de input", "combo", "Controles", (("dinput", "DirectInput"), ("xinput", "XInput"), ("rawinput", "Raw Input"), ("sdl", "SDL"))),
        ...
        "retroarch": (
            SettingSpec("video_driver", "Driver de vídeo", "combo", "Vídeo", (("gl", "OpenGL"), ("d3d11", "Direct3D 11"), ("d3d12", "Direct3D 12"), ("vulkan", "Vulkan"), ("sdl2", "SDL2"))),
            ...
            SettingSpec("video_fullscreen_x", "Resolução X", "slider", "Vídeo", minimum=0, maximum=7680),
            SettingSpec("video_fullscreen_y", "Resolução Y", "slider", "Vídeo", minimum=0, maximum=4320),
            SettingSpec("video_monitor_index", "Monitor", "slider", "Vídeo", minimum=0, maximum=8),
            SettingSpec("audio_enable", "Áudio", "bool", "Áudio"),
            SettingSpec("audio_driver", "Driver de áudio", "combo", "Áudio", (("wasapi", "WASAPI"), ("xaudio", "XAudio"), ("sdl", "SDL"), ("null", "Nulo"))),
            SettingSpec("audio_out_rate", "Sample rate", "combo", "Áudio", (("32000", "32 kHz"), ("44100", "44.1 kHz"), ("48000", "48 kHz"), ("96000", "96 kHz"))),
            SettingSpec("audio_sync", "Sincronizar áudio", "bool", "Áudio"),
            SettingSpec("audio_latency", "Latência (ms)", "slider", "Áudio", minimum=1, maximum=256),
            ...
            SettingSpec("input_driver", "Driver de input", "combo", "Controles", (("dinput", "DirectInput"), ("sdl", "SDL"), ("raw", "Raw"), ("xinput", "XInput"))),
            SettingSpec("input_joypad_driver", "Driver de gamepad", "combo", "Controles", (("dinput", "DirectInput"), ("sdl", "SDL"), ("xinput", "XInput"))),
            SettingSpec("input_autodetect_enable", "Autodetectar controles", "bool", "Controles"),
            SettingSpec("input_axis_threshold", "Threshold dos eixos", "slider", "Controles", minimum=0, maximum=100),
            SettingSpec("menu_driver", "Interface do RetroArch", "combo", "Interface", (("rgui", "RGUI"), ("xmb", "XMB"), ("ozone", "Ozone"), ("glui", "GLUI"))),
    ...
    def _build_ui(self) -> None:
        ...
        info = QLabel("Somente opções documentadas e presentes no arquivo real ficam editáveis. Salvar cria backup e altera apenas as chaves suportadas.")
    ...
    def _build_emulator(self, emulator: str) -> None:
        ...
        tabs = QTabWidget()
        categories = sorted({spec.category for spec in self.SPECS[emulator]}, key=lambda x: (x == "Avançado", x))
        for category in categories:
            ...
            specs = [s for s in self.SPECS[emulator] if s.category == category]
            for spec in specs:
                control = self._make_control(emulator, spec)
    ...
    def _make_control(self, emulator: str, spec: SettingSpec) -> QWidget:
        ...
        if spec.kind == "slider":
            ...
            widget._serm_slider = slider  # type: ignore[attr-defined]
    ...
    def _parse_bool(value: str) -> bool:
        """Converte os formatos booleanos comuns dos emuladores."""
    ...
    def _set_control(self, control: QWidget, spec: SettingSpec, raw: str) -> None:
        ...
        if spec.kind == "bool":
            ...
            control.setChecked(self._parse_bool(raw))
        elif spec.kind == "combo":
            assert isinstance(control, QComboBox)
            index = control.findData(raw.strip().strip('"'))
            if index >= 0:
                control.setCurrentIndex(index)
            else:
                control.setCurrentIndex(-1)
                control.setToolTip(f"Valor atual não está entre os valores documentados: {raw}")
        elif spec.kind == "slider":
            slider = control._serm_slider  # type: ignore[attr-defined]
            spin = control._serm_spin  # type: ignore[attr-defined]
            try:
                number = int(float(raw.replace(",", ".")))
            except ValueError:
                number = spec.minimum
            number = max(spec.minimum, min(spec.maximum, number))
            slider.setValue(number); spin.setValue(number)
        else:
            control.setText(raw.strip().strip('"'))  # type: ignore[attr-defined]
    ...
    def save(self, emulator: str) -> None:
        ...
        editor = self._editor(emulator)
        if editor is None:
            QMessageBox.warning(self, "Configuração", "Arquivo de configuração não encontrado. Configure-o primeiro na guia Diretórios.")
            return
        changed = 0
        try:
            for spec in self.SPECS[emulator]:
                ...
                if not values:
                    continue
                control = self.controls[(emulator, spec.key)]
                value = self._control_value(control, spec, values[0])
