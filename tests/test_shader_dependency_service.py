...
def test_official_shader_does_not_require_download(tmp_path: Path) -> None:
    ...
    profile = ShaderProfile("official", "Official", "system.slangp", shader.reference, "libretro", "https://github.com/libretro/slang-shaders")
...
def test_third_party_shader_is_reported_as_missing(tmp_path: Path) -> None:
    ...
    profile = ShaderProfile("third", "Third", "third.slangp", shader.reference, "vendor/third", "https://github.com/vendor/third")
    dependency = service.inspect(shader, profile)
