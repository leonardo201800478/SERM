...
class LaunchBoxIntegrationService:
    ...
    PLATFORM_ALIASES: dict[str, tuple[str, str, str, tuple[str, ...]]] = {
        ...
        "atari 2600": ("Atari 2600", "consoles", "8-bit", ("atari2600", "2600", "atari - 2600")),
        ...
        "atari jaguar cd": ("Atari Jaguar CD", "consoles", "64-bit", ("jaguar cd", "jaguarcd")),
        ...
        "windows": ("Windows", "computers", "32-bit", ("windows", "pc")),
    }
